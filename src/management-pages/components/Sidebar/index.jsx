...
const Themes = (props) => {
  ...
  if (color === "dark") {
    changeColor = (
      <div className="nav-link-custom">
        ...
        <span className="link-text">Moon</span>
      </div>
    );
  } else if (color === "solar") {
    changeColor = (
      <div className="nav-link-custom">
        ...
        <span className="link-text">Solar</span>
      </div>
    );
  } else if (color === "light") {
    changeColor = (
  ...
  } else console.log("error when change color");

  return <>{changeColor}</>;
};

function Sidebar(props) {
  const { handleChangeTheme, theme } = props;

  const onChangeTheme = () => {
    console.log("handle theme: ", theme);
