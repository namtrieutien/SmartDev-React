                ...
                <div className="card-body card-profile">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      ...
                      <button className="btn btn-outline-primary"> <img classname="feather feather-globe mr-5 icon-inline" width={40} height={40} src={require(`./img/heart.png`).default} alt="Fav" />Create Post</button>
                    </div>
                  </div>
                </div>
              </div>
