                ...
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="text-muted font-size-sm"> {data.user.address.commune}, {data.user.address.district},{data.user.address.city}</p>
                      <button className="btn btn-primary mr-3">Giỏ hàng</button>
                      <button className="btn btn-outline-primary">Yêu thích</button>
                    </div>
                  </div>
                </div>
              </div>
